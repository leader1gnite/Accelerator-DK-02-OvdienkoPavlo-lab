// -------------------------------------------------------------
// 
// File Name: hdlsrc\flatpoint\Enabled_Subsystem_tb.v
// Created: 2023-01-13 05:23:25
// 
...
module Enabled_Subsystem_tb;
  ...
  assign i_VALID_active = i_VALID_addr != 7'b1100100;
  ...
  always @(posedge clk or posedge reset)
    begin : i_VALID_1_process
      if (reset == 1'b1) begin
        i_VALID_addr <= 7'b0000000;
      end
      else begin
        if (i_VALID_enb) begin
          if (i_VALID_addr >= 7'b1100100) begin
            i_VALID_addr <= 7'b0000000;
          end
          else begin
            i_VALID_addr <= i_VALID_addr + 7'b0000001;
          end
        end
      end
    end
