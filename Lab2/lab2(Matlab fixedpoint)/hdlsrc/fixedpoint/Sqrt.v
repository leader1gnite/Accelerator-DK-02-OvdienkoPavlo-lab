// -------------------------------------------------------------
// 
// File Name: hdlsrc\fixedpoint\Sqrt.v
...
// 
// Module: Sqrt
// Source Path: fixedpoint/Enabled Subsystem/Sqrt
// Hierarchy Level: 1
// 
// -------------------------------------------------------------
...
module Sqrt
  ...
  input   reset;
  input   enb;
  input   signed [63:0] din;  // sfix64_En18
  output  signed [32:0] dout;  // sfix33_En9


  wire [1:0] Root_Square0_temp1;  // ufix2
  wire [65:0] resizedin;  // ufix66_En18
  ...
  wire signed [32:0] outdata_1;  // sfix33_En9
